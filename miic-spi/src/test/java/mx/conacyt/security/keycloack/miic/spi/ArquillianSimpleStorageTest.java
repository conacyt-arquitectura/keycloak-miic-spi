...
import mx.conacyt.security.keycloack.miic.spi.util.StorageManager;
...
import static mx.conacyt.security.keycloack.miic.spi.util.StorageManager.addUser;
import static mx.conacyt.security.keycloack.miic.spi.util.StorageManager.createStorage;
import static mx.conacyt.security.keycloack.miic.spi.util.StorageManager.deleteStorage;
import static mx.conacyt.security.keycloack.miic.spi.util.StorageManager.getPropertyFile;
    ...
    public static Archive<?> createTestArchive() throws IOException {
        return ShrinkWrap.create(JavaArchive.class, "user-storage-simple-example.jar")
                .addClasses(
                        ...
                        mx.conacyt.security.keycloack.miic.spi.readonly.PropertyFileUserStorageProvider.class,
                        mx.conacyt.security.keycloack.miic.spi.readonly.PropertyFileUserStorageProviderFactory.class,
                        mx.conacyt.security.keycloack.miic.spi.writeable.PropertyFileUserStorageProvider.class,
                        mx.conacyt.security.keycloack.miic.spi.writeable.PropertyFileUserStorageProviderFactory.class)
